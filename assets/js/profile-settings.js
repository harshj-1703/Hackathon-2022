...
(function($) {
    ...
    $(".education-info").on('click','.trash', function () {
		...
		// console.log($(this).closest('.education-cont'));
		// edu--;
		return false;
    });
				...
				'<div class="row form-row">' +
					...
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							...
							'<input type="number" class="form-control" name="yoc[]">' +
						'</div>' +
					'</div>' +
				'</div>' +
			'</div>' +
			...
			'<div class="col-12 col-md-10 col-lg-11">' +
				'<div class="row form-row">' +
					...
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							'<label>From</label>' +
							'<input type="date" class="form-control" name="hospitalfrom[]">' +
						'</div>' +
					'</div>' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							'<label>To</label>' +
							'<input type="date" class="form-control" name="hospitalto[]">' +
						'</div>' +
					'</div>' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							'<label>Designation</label>' +
							'<input type="text" class="form-control" name="hospitaldest[]">' +
						'</div>' +
					'</div>' +
				'</div>' +
			'</div>' +
    ...
    $(".add-award").on('click', function () {
        ...
        var regcontent = '<div class="row form-row awards-cont">' +
			...
			'<div class="col-12 col-md-5">' +
				'<div class="form-group">' +
					'<label>Year</label>' +
					'<input type="number" class="form-control" name="awardyear[]">' +
				'</div>' +
			'</div>' +
    ...
    $(".add-reg").on('click', function () {
        ...
        var regcontent = '<div class="row form-row reg-cont">' +
			...
			'<div class="col-12 col-md-5">' +
				'<div class="form-group">' +
					'<label>Year</label>' +
					'<input type="number" class="form-control" name="regyear[]">' +
				'</div>' +
			'</div>' +
			'<div class="col-12 col-md-2">' +
				'<label class="d-md-block d-sm-none d-none">&nbsp;</label>' +
